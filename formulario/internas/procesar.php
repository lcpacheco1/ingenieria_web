<?php
	...
	$result=mysql_query($query) or die ('error de sql');//resul set 
	...
	echo '<script>alert("Datos Guardados")</script>';//alterta 
	//echo "<script>location.href='../internas/personas_registradas.php'</script>";
	echo "<script>location.href='personas_registradas.php'</script>";//Para linkear a otro archivo php 
